...
function add_div() {
   ...
   var person_contentflydiv_namebar = document.createElement('div');
    ...
    person_contentflydiv_date.innerHTML = "a free man,china,joined december 2018"
    ...
    person_contentflydiv_button.innerHTML = "Following"
    ...
    //detail_div++;
    //totaltweet++;
    //ocument.getElementById('Label1').innerHTML = totaltweet
}
